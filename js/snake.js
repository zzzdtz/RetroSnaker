;(function (window, undefined){
	...
	*/
	Snake.prototype.move = function(direction){
		if(typeof direction === "undefined" && typeof Snakedie === "undefined"){
			direction = "left";
		}
	...
	*/
	Snake.prototype.eat = function (){
		...
		if(snakeHead.x == this._food.x && snakeHead.y == this._food.y && typeof Snakedie === "undefined"){
			// 将吃到的食物添加到蛇身中去
